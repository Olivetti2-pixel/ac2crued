...
import { collection,addDoc, getDocs, orderBy, query, deleteDoc, doc, getDoc, updateDoc } from 'firebase/firestore';
...
export default function Read() {
  ...
  //mostrar contatpo selecionado
  const [ID,setID]=useState(null)
  const [contatoUnico,setContatoUnico]=useState({})
  const [mostrar,setMonstrar]=useState(false)
